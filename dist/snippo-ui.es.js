...
import wr, { useState as ge, useCallback as ce, forwardRef as Vr, useContext as Br, useLayoutEffect as qi, useRef as Re, useMemo as Ye, createContext as ea, Component as ta, Fragment as _t, useEffect as Je } from "react";
...
function ra() {
  ...
  function o(s, u, c) {
    var f, l = {}, m = null, b = null;
    c !== void 0 && (m = "" + c), u.key !== void 0 && (m = "" + u.key), u.ref !== void 0 && (b = u.ref);
    for (f in u) i.call(u, f) && !a.hasOwnProperty(f) && (l[f] = u[f]);
    if (s && s.defaultProps) for (f in u = s.defaultProps, u) l[f] === void 0 && (l[f] = u[f]);
    return { $$typeof: t, type: s, key: m, ref: b, props: l, _owner: n.current };
  }
...
function ia() {
  return Xn || (Xn = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function A(d) {
      {
        for (var y = arguments.length, R = new Array(y > 1 ? y - 1 : 0), T = 1; T < y; T++)
          R[T - 1] = arguments[T];
        G("error", d, R);
      }
    }
    function G(d, y, R) {
      {
        var T = C.ReactDebugCurrentFrame, H = T.getStackAddendum();
        H !== "" && (y += "%s", R = R.concat([H]));
        var z = R.map(function(N) {
          return String(N);
        });
        z.unshift("Warning: " + y), Function.prototype.apply.call(console[d], console, z);
      }
    }
    var h = !1, g = !1, x = !1, E = !1, S = !1, W;
    W = Symbol.for("react.module.reference");
    function $(d) {
      return !!(typeof d == "string" || typeof d == "function" || d === i || d === a || S || d === n || d === c || d === f || E || d === b || h || g || x || typeof d == "object" && d !== null && (d.$$typeof === m || d.$$typeof === l || d.$$typeof === o || d.$$typeof === s || d.$$typeof === u || // This needs to include all possible module reference object
      ...
      if (typeof d == "object")
        switch (d.$$typeof) {
          ...
          case l:
            ...
            return T !== null ? T : Q(d.type) || "Memo";
          case m: {
            var H = d, z = H._payload, N = H._init;
            try {
              return Q(N(z));
            } catch {
              return null;
    ...
    var ee = Object.assign, J = 0, V, j, k, ae, le, xe, _;
    function ue() {
    }
    ...
    function Ie() {
      {
        if (J === 0) {
          V = console.log, j = console.info, k = console.warn, ae = console.error, le = console.group, xe = console.groupCollapsed, _ = console.groupEnd;
          var d = {
            configurable: !0,
            enumerable: !0,
            value: ue,
    ...
    var oe = C.ReactCurrentDispatcher, ve;
    function de(d, y, R) {
      {
        if (ve === void 0)
          try {
...
` + ve + d;
    ...
    function F(d, y) {
      ...
      var z;
      z = oe.current, oe.current = null, Ie();
      try {
        if (y) {
          var N = function() {
            throw Error();
...
`), pe = T.stack.split(`
`), te = X.length - 1, ne = pe.length - 1; te >= 1 && ne >= 0 && X[te] !== pe[ne]; )
            ne--;
          for (; te >= 1 && ne >= 0; te--, ne--)
            if (X[te] !== pe[ne]) {
              if (te !== 1 || ne !== 1)
                do
                  if (te--, ne--, ne < 0 || X[te] !== pe[ne]) {
                    var ye = `
` + X[te].replace(" at new ", " at ");
        ...
        Ee = !1, oe.current = z, Ae(), Error.prepareStackTrace = H;
      }
      var He = d ? d.displayName || d.name : "", We = He ? de(He) : "";
      ...
      if (typeof d == "object")
        switch (d.$$typeof) {
          case u:
            return Xe(d.render);
          case l:
            return Ve(d.type, y, R);
          case m: {
            var T = d, H = T._payload, z = T._init;
            try {
              return Ve(z(H), y, R);
            } catch {
            }
    ...
    function at(d) {
      if (d) {
        var y = d._owner, R = Ve(d.type, d._source, y ? y.type : null);
        An.setExtraStackFrame(R);
      } else
        An.setExtraStackFrame(null);
    }
    function Bi(d, y, R, T, H) {
      {
          ...
          if (z(d, N)) {
            ...
            try {
              if (typeof d[N] != "function") {
                var pe = Error((T || "React class") + ": " + R + " type `" + N + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof d[N] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw pe.name = "Invariant Violation", pe;
              }
              X = d[N](y, N, T, R, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (te) {
              X = te;
            }
            X && !(X instanceof Error) && (at(H), A("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", T || "React class", R, N, typeof X), at(null)), X instanceof Error && !(X.message in Cn) && (Cn[X.message] = !0, at(H), A("Failed %s type: %s", R, X.message), at(null));
          }
      }
    }
    ...
    function Ti(d) {
      {
        var y = typeof Symbol == "function" && Symbol.toStringTag, R = y && d[Symbol.toStringTag] || d.constructor.name || "Object";
        return R;
      }
    }
    function Oi(d) {
    ...
    function xn(d) {
      if (Oi(d))
        return A("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", Ti(d)), yn(d);
    }
    ...
    function Di(d, y) {
      {
        var R = function() {
          Gn || (Gn = !0, A("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", y));
        };
    ...
    function Zi(d, y) {
      {
        var R = function() {
          Sn || (Sn = !0, A("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", y));
        };
    ...
    function Li(d, y, R, T, H) {
      {
        var z, N = {}, X = null, pe = null;
        R !== void 0 && (xn(R), X = "" + R), Mi(y) && (xn(y.key), X = "" + y.key), Wi(y) && (pe = y.ref, Ni(y, H));
        for (z in y)
          _e.call(y, z) && !Xi.hasOwnProperty(z) && (N[z] = y[z]);
        if (d && d.defaultProps) {
        ...
        if (X || pe) {
          ...
          X && Di(N, ne), pe && Zi(N, ne);
        }
        return Hi(d, X, pe, H, T, En.current, N);
      }
    }
    var Xt = C.ReactCurrentOwner, Rn = C.ReactDebugCurrentFrame;
    function Ze(d) {
      if (d) {
        var y = d._owner, R = Ve(d.type, d._source, y ? y.type : null);
...
Check the top-level render call using <` + R + ">.");
    ...
    function Vn(d, y) {
      {
        ...
        wn[R] = !0;
        var T = "";
        d && d._owner && d._owner !== Xt.current && (T = " It was passed a child from " + Q(d._owner.type) + "."), Ze(d), A('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', R, T), Ze(null);
      }
    }
    function Bn(d, y) {
      {
        ...
        if (Ot(d))
          ...
          if (typeof H == "function" && H !== d.entries)
            for (var z = H.call(d), N; !(N = z.next()).done; )
              Mt(N.value) && Vn(N.value, y);
        }
      }
    }
    function ji(d) {
    ...
    function zi(d) {
      {
        for (var y = Object.keys(d.props), R = 0; R < y.length; R++) {
          var T = y[R];
          if (T !== "children" && T !== "key") {
            Ze(d), A("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", T), Ze(null);
            break;
          }
        }
        d.ref !== null && (Ze(d), A("Invalid attribute `ref` supplied to `React.Fragment`."), Ze(null));
      }
    }
    var Pn = {};
    function Tn(d, y, R, T, H, z) {
      {
        var N = $(d);
        if (!N) {
          var X = "";
          ...
          pe ? X += pe : X += Fn();
          var te;
          d === null ? te = "null" : Ot(d) ? te = "array" : d !== void 0 && d.$$typeof === t ? (te = "<" + (Q(d.type) || "Unknown") + " />", X = " Did you accidentally export a JSX literal instead of a component?") : te = typeof d, A("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", te, X);
        }
        var ne = Li(d, y, R, H, z);
        if (ne == null)
          return ne;
        ...
        if (_e.call(y, "key")) {
          var We = Q(d), me = Object.keys(y).filter(function(Ki) {
            return Ki !== "key";
...
function fa(e) {
  var t = e.defaultInputValue, r = t === void 0 ? "" : t, i = e.defaultMenuIsOpen, n = i === void 0 ? !1 : i, a = e.defaultValue, o = a === void 0 ? null : a, s = e.inputValue, u = e.menuIsOpen, c = e.onChange, f = e.onInputChange, l = e.onMenuClose, m = e.onMenuOpen, b = e.value, I = Te(e, da), p = ge(s !== void 0 ? s : r), v = Be(p, 2), C = v[0], A = v[1], G = ge(u !== void 0 ? u : n), h = Be(G, 2), g = h[0], x = h[1], E = ge(b !== void 0 ? b : o), S = Be(E, 2), W = S[0], $ = S[1], q = ce(function(k, ae) {
    typeof c == "function" && c(k, ae), $(k);
  }, [c]), U = ce(function(k, ae) {
    var le;
    typeof f == "function" && (le = f(k, ae)), A(le !== void 0 ? le : k);
  }, [f]), Q = ce(function() {
    typeof m == "function" && m(), x(!0);
  }, [m]), ee = ce(function() {
    typeof l == "function" && l(), x(!1);
  }, [l]), J = s !== void 0 ? s : C, V = u !== void 0 ? u : g, j = b !== void 0 ? b : W;
  return B(B({}, I), {}, {
    inputValue: J,
    menuIsOpen: V,
    onChange: q,
...
}(), fe = "-ms-", Ct = "-moz-", D = "-webkit-", Xr = "comm", on = "rule", sn = "decl", Ga = "@import", Wr = "@keyframes", Sa = "@layer", Ra = Math.abs, Rt = String.fromCharCode, Fa = Object.assign;
function wa(e, t) {
...
var Ft = 1, ze = 1, Nr = 0, he = 0, re = 0, ke = "";
function wt(e, t, r, i, n, a, o) {
  return { value: e, root: t, parent: r, type: i, props: n, children: a, line: Ft, column: ze, length: o, return: "" };
}
function $e(e, t) {
...
function Ta() {
  return re = he > 0 ? se(ke, --he) : 0, ze--, re === 10 && (ze = 1, Ft--), re;
}
function Ce() {
  return re = he < Nr ? se(ke, he++) : 0, ze++, re === 10 && (ze = 1, Ft++), re;
}
function Fe() {
  return se(ke, he);
}
...
function Dr(e) {
  return Ft = ze = 1, Nr = Ge(ke = e), he = 0, [];
}
function Zr(e) {
  return ke = "", e;
}
function vt(e) {
  return Mr(it(he - 1, Kt(e === 91 ? e + 2 : e === 40 ? e + 1 : e)));
}
function Oa(e) {
  for (; (re = Fe()) && re < 33; )
    Ce();
  return nt(e) > 2 || nt(re) > 3 ? "" : " ";
}
function Xa(e, t) {
  for (; --t && Ce() && !(re < 48 || re > 102 || re > 57 && re < 65 || re > 70 && re < 97); )
    ;
  return it(e, bt() + (t < 6 && Fe() == 32 && Ce() == 32));
}
function Kt(e) {
  for (; Ce(); )
    switch (re) {
...
function mt(e, t, r, i, n, a, o, s, u) {
  for (var c = 0, f = 0, l = o, m = 0, b = 0, I = 0, p = 1, v = 1, C = 1, A = 0, G = "", h = n, g = a, x = i, E = G; v; )
    switch (I = A, A = Ce()) {
      // (
      case 40:
        if (I != 108 && se(E, l - 1) == 58) {
          $t(E += Z(vt(A), "&", "&\f"), "&\f") != -1 && (C = -1);
          break;
        }
      // " ' [
      case 34:
      ...
      case 0:
        switch (A) {
          ...
          // ;
          case 59 + f:
            C == -1 && (E = Z(E, /\f/g, "")), b > 0 && Ge(E) - l && ot(b > 32 ? Zn(E + ";", i, r, l - 1) : Zn(Z(E, " ", "") + ";", i, r, l - 2), u);
            break;
          // @ ;
          case 59:
            E += ";";
          // { rule/at-rule
          default:
            if (ot(x = Dn(E, t, r, c, f, n, s, G, h = [], g = [], l), a), A === 123)
              if (f === 0)
                mt(E, t, x, x, h, a, l, s, g);
              else
                switch (m === 99 && se(E, 3) === 110 ? 100 : m) {
                  // d l m s
                  case 100:
                  case 108:
                  case 109:
      ...
      default:
        ...
        switch (E += Rt(A), A * p) {
          ...
          // @
          case 64:
            Fe() === 45 && (E += vt(Ce())), m = Fe(), f = l = Ge(G = E += Ma(bt())), A++;
            break;
          // -
          case 45:
            I === 45 && Ge(E) == 2 && (p = 0);
...
function Dn(e, t, r, i, n, a, o, s, u, c, f) {
  for (var l = n - 1, m = n === 0 ? a : [""], b = cn(m), I = 0, p = 0, v = 0; I < i; ++I)
    for (var C = 0, A = tt(e, l + 1, l = Ra(p = o[I])), G = e; C < b; ++C)
      (G = Mr(p > 0 ? m[C] + " " + A : Z(A, /&\f/g, m[C]))) && (u[v++] = G);
  return wt(e, t, r, n === 0 ? on : s, u, c, f);
}
function Da(e, t, r) {
  return wt(e, t, r, Xr, Rt(Pa()), tt(e, 2, -2), 0);
}
function Zn(e, t, r, i) {
...
function Za(e, t, r, i) {
  switch (e.type) {
    ...
    case Xr:
      return "";
    case Wr:
      return e.return = e.value + "{" + je(e.children, i) + "}";
    case on:
      e.value = e.props.join(",");
  }
  return Ge(r = je(e.children, i)) ? e.return = e.value + "{" + r + "}" : "";
}
function Ha(e) {
  var t = cn(e);
...
var Ja = function(t, r, i) {
  for (var n = 0, a = 0; n = a, a = Fe(), n === 38 && a === 12 && (r[i] = 1), !nt(a); )
    Ce();
  return it(t, he);
}, ja = function(t, r) {
  var i = -1, n = 44;
  do
    switch (nt(n)) {
      case 0:
        n === 38 && Fe() === 12 && (r[i] = 1), t[i] += Ja(he - 1, r, i);
        break;
      case 2:
        t[i] += vt(n);
        break;
  ...
  t.length < 1)) {
    ...
    if (!(t.props.length === 1 && r.charCodeAt(0) !== 58 && !Hn.get(i)) && !n) {
      Hn.set(t, !0);
      for (var a = [], o = za(r, a), s = i.props, u = 0, c = 0; u < o.length; u++)
...
function Hr(e, t) {
  switch (wa(e, t)) {
    ...
    // order
    case 6165:
      return D + e + fe + "flex-" + e + e;
    // align-items
    case 5187:
      return D + e + Z(e, /(\w+).+(:[^]+)/, D + "box-$1$2" + fe + "flex-$1$2") + e;
    // align-self
    case 5443:
      return D + e + fe + "flex-item-" + Z(e, /flex-|-self/, "") + e;
    // align-content
    case 4675:
      return D + e + fe + "flex-line-pack" + Z(e, /align-content|flex-|-self/, "") + e;
    // flex-shrink
    case 5548:
      return D + e + fe + Z(e, "shrink", "negative") + e;
    // flex-basis
    case 5292:
      return D + e + fe + Z(e, "basis", "preferred-size") + e;
    // flex-grow
    case 6060:
      return D + "box-" + Z(e, "-grow", "") + D + e + fe + Z(e, "grow", "positive") + e;
    // transition
    case 4554:
    ...
    // justify-content
    case 4968:
      return Z(Z(e, /(.+:)(flex-)?(.*)/, D + "box-pack:$3" + fe + "flex-pack:$3"), /s.+-b[^;]+/, "justify") + D + e + e;
    ...
    case 5021:
    case 4765:
      if (Ge(e) - 1 - t > 6) switch (se(e, t + 1)) {
        // (m)ax-content, (m)in-content
        case 109:
          if (se(e, t + 4) !== 45) break;
        // (f)ill-available, (f)it-content
        case 102:
          return Z(e, /(.+:)(.+)-([^]+)/, "$1" + D + "$2-$3$1" + Ct + (se(e, t + 3) == 108 ? "$3" : "$2-$3")) + e;
        // (s)tretch
        case 115:
    ...
    case 6444:
      switch (se(e, Ge(e) - 3 - (~$t(e, "!important") && 10))) {
        // stic(k)y
        case 107:
          return Z(e, ":", ":" + D) + e;
        // (inline-)?fl(e)x
        case 101:
          return Z(e, /(.+:)([^;!]+)(;|!.+)?/, "$1" + D + (se(e, 14) === 45 ? "inline-" : "") + "box$3$1" + D + "$2$3$1" + fe + "$2box$3") + e;
      }
      break;
    // writing-mode
    case 5936:
      switch (se(e, t + 11)) {
        // vertical-l(r)
        case 114:
          return D + e + fe + Z(e, /[svh]\w+-[tblr]{2}/, "tb") + e;
        // vertical-r(l)
        case 108:
          return D + e + fe + Z(e, /[svh]\w+-[tblr]{2}/, "tb-rl") + e;
        // horizontal(-)tb
        case 45:
          return D + e + fe + Z(e, /[svh]\w+-[tblr]{2}/, "lr") + e;
      }
      return D + e + fe + e + e;
  }
  return e;
...
var Ua = function(t, r, i, n) {
  ...
  var u, c = [ka, _a];
  {
    var f, l = [Za, La(function(p) {
      f.insert(p);
    })], m = Ha(c.concat(n, l)), b = function(v) {
      return je(Na(v), m);
    };
    u = function(v, C, A, G) {
      f = A, b(v ? v + "{" + C.styles + "}" : C.styles), G && (I.inserted[C.name] = !0);
    };
  }
  var I = {
    key: r,
...
function Ka() {
  ...
  return L.AsyncMode = u, L.ConcurrentMode = c, L.ContextConsumer = s, L.ContextProvider = o, L.Element = t, L.ForwardRef = f, L.Fragment = i, L.Lazy = I, L.Memo = b, L.Portal = r, L.Profiler = a, L.StrictMode = n, L.Suspense = l, L.isAsyncMode = function(g) {
    return h(g) || G(g) === u;
  }, L.isConcurrentMode = h, L.isContextConsumer = function(g) {
    return G(g) === s;
    ...
    return typeof g == "string" || typeof g == "function" || g === i || g === c || g === a || g === n || g === l || g === m || typeof g == "object" && g !== null && (g.$$typeof === I || g.$$typeof === b || g.$$typeof === o || g.$$typeof === s || g.$$typeof === f || g.$$typeof === v || g.$$typeof === C || g.$$typeof === A || g.$$typeof === p);
  }, L.typeOf = G, L;
}
var Y = {};
/** @license React v16.13.1
...
function qa() {
  return Yn || (Yn = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function G(F) {
      ...
      F === i || F === c || F === a || F === n || F === l || F === m || typeof F == "object" && F !== null && (F.$$typeof === I || F.$$typeof === b || F.$$typeof === o || F.$$typeof === s || F.$$typeof === f || F.$$typeof === v || F.$$typeof === C || F.$$typeof === A || F.$$typeof === p);
    }
    function h(F) {
    ...
    var g = u, x = c, E = s, S = o, W = t, $ = f, q = i, U = I, Q = b, ee = r, J = a, V = n, j = l, k = !1;
    function ae(F) {
      return k || (k = !0, console.warn("The ReactIs.isAsyncMode() alias has been deprecated, and will be removed in React 17+. Update your code to use ReactIs.isConcurrentMode() instead. It has the exact same API.")), le(F) || h(F) === u;
    }
    function le(F) {
      return h(F) === c;
    }
    ...
    Y.AsyncMode = g, Y.ConcurrentMode = x, Y.ContextConsumer = E, Y.ContextProvider = S, Y.Element = W, Y.ForwardRef = $, Y.Fragment = q, Y.Lazy = U, Y.Memo = Q, Y.Portal = ee, Y.Profiler = J, Y.StrictMode = V, Y.Suspense = j, Y.isAsyncMode = ae, Y.isConcurrentMode = le, Y.isContextConsumer = xe, Y.isContextProvider = _, Y.isElement = ue, Y.isForwardRef = Ie, Y.isFragment = Ae, Y.isLazy = oe, Y.isMemo = ve, Y.isPortal = de, Y.isProfiler = Ee, Y.isStrictMode = Oe, Y.isSuspense = De, Y.isValidElementType = G, Y.typeOf = h;
  }()), Y;
}
var Jn;
function eu() {
...
function tu() {
  ...
  var s = Object.defineProperty, u = Object.getOwnPropertyNames, c = Object.getOwnPropertySymbols, f = Object.getOwnPropertyDescriptor, l = Object.getPrototypeOf, m = Object.prototype;
  function b(I, p, v) {
    if (typeof p != "string") {
      if (m) {
        var C = l(p);
      ...
      var A = u(p);
      c && (A = A.concat(c(p)));
      for (var G = o(I), h = o(p), g = 0; g < A.length; ++g) {
        var x = A[g];
        if (!r[x] && !(v && v[x]) && !(h && h[x]) && !(G && G[x])) {
          var E = f(p, x);
          try {
            s(I, x, E);
          } catch {
...
var lu = function(t) {
  return t();
}, du = O.useInsertionEffect ? O.useInsertionEffect : !1, fu = du || lu, jr = /* @__PURE__ */ O.createContext(
...
var gu = function(t) {
...
}, pu = /* @__PURE__ */ O.createContext({}), ln = {}.hasOwnProperty, qt = "__EMOTION_TYPE_PLEASE_DO_NOT_USE__", bu = function(t, r) {
  var i = {};
  for (var n in r)
    ln.call(r, n) && (i[n] = r[n]);
  return i[qt] = t, i;
  ...
  var s = Jr(a, void 0, O.useContext(pu));
  o += t.key + "-" + s.name;
  var u = {};
  for (var c in e)
    ln.call(e, c) && c !== "css" && c !== qt && (u[c] = e[c]);
  return u.className = o, r && (u.ref = r), /* @__PURE__ */ O.createElement(O.Fragment, null, /* @__PURE__ */ O.createElement(vu, {
    cache: t,
    serialized: s,
    isStringTag: typeof n == "string"
  }), /* @__PURE__ */ O.createElement(n, u));
}), hu = mu, w = function(t, r) {
  var i = arguments;
...
const Ru = /* @__PURE__ */ new Set(["html", "body", "#document"]);
function Fu(e) {
  return Ru.has(zr(e));
}
function gn(e) {
...
function $n(e, t, r, i) {
  ...
  if (a) {
    ...
    let I = m, p = en(I);
    for (; p && i && b !== I; ) {
      const v = Qn(p), C = p.getBoundingClientRect(), A = gn(p), G = C.left + (p.clientLeft + parseFloat(A.paddingLeft)) * v.x, h = C.top + (p.clientTop + parseFloat(A.paddingTop)) * v.y;
      u *= v.x, c *= v.y, f *= v.x, l *= v.y, u += G, c += h, I = Pe(p), p = en(I);
    }
  }
  return xu({
    width: f,
...
function Ou(e, t) {
  ...
  function o(s, u) {
    ...
    if (s || t(), !m || !b)
      return;
    const I = ct(l), p = ct(n.clientWidth - (f + m)), v = ct(n.clientHeight - (l + b)), C = ct(f), G = {
      rootMargin: -I + "px " + -p + "px " + -v + "px " + -C + "px",
...
function Xu(e, t, r, i) {
  ...
  o && (b = new ResizeObserver((C) => {
    let [A] = C;
    A && A.target === c && b && (b.unobserve(t), cancelAnimationFrame(m), m = requestAnimationFrame(() => {
      var G;
  ...
  function v() {
    const C = $n(e);
    p && !$r(p, C) && r(), p = C, I = requestAnimationFrame(v);
  }
  return r(), () => {
    var C;
    f.forEach((A) => {
      n && A.removeEventListener("scroll", r), a && A.removeEventListener("resize", r);
...
function $u(e) {
  ...
  var f = u.getBoundingClientRect(), l = f.height, m = r.getBoundingClientRect(), b = m.bottom, I = m.height, p = m.top, v = r.offsetParent.getBoundingClientRect(), C = v.top, A = o ? window.innerHeight : Du(u), G = qr(u), h = parseInt(getComputedStyle(r).marginBottom, 10), g = parseInt(getComputedStyle(r).marginTop, 10), x = C - g, E = A - p, S = x + G, W = l - G - p, $ = b - A + G + h, q = G + p - g, U = 160;
  switch (n) {
    case "auto":
    case "bottom":
      if (E >= I)
      ...
      if (n === "auto" || o) {
        var ee = t, J = o ? x : S;
        return J >= i && (ee = Math.min(J - h - s, t)), {
          placement: "top",
          maxHeight: ee
        };
      }
    ...
    case "top":
      ...
      if (!o && S >= i || o && x >= i) {
        var V = t;
        return (!o && S >= i || o && x >= i) && (V = o ? x - g : S - g), a && lt(u, q, U), {
          placement: "top",
          maxHeight: V
        };
      }
...
var ti = function(t) {
  ...
  var r = t.children, i = t.minMenuHeight, n = t.maxMenuHeight, a = t.menuPlacement, o = t.menuPosition, s = t.menuShouldScrollIntoView, u = t.theme, c = Br(ni) || {}, f = c.setPortalPlacement, l = Re(null), m = ge(n), b = Be(m, 2), I = b[0], p = b[1], v = ge(null), C = Be(v, 2), A = C[0], G = C[1], h = u.spacing.controlHeight;
  return tn(function() {
    var g = l.current;
    if (g) {
      var x = o === "fixed", E = s && !x, S = $u({
        maxHeight: n,
        menuEl: g,
        minHeight: i,
        placement: a,
      ...
      p(S.maxHeight), G(S.placement), f?.(S.placement);
    }
  }, [n, a, o, s, i, f, h]), r({
    ref: l,
    placerProps: B(B({}, t), {}, {
  ...
  var r = t.appendTo, i = t.children, n = t.controlElement, a = t.innerProps, o = t.menuPlacement, s = t.menuPosition, u = Re(null), c = Re(null), f = ge(ti(o)), l = Be(f, 2), m = l[0], b = l[1], I = Ye(function() {
    return {
      setPortalPlacement: b
    };
  }, []), p = ge(null), v = Be(p, 2), C = v[0], A = v[1], G = ce(function() {
    if (n) {
      var E = Lu(n), S = s === "fixed" ? 0 : window.pageYOffset, W = E[m] + S;
      (W !== C?.offset || E.left !== C?.rect.left || E.width !== C?.rect.width) && A({
        offset: W,
        rect: E
      });
    }
  }, [n, s, m, C?.offset, C?.rect.left, C?.rect.width]);
  tn(function() {
    G();
  }, [G]);
  var h = ce(function() {
  ...
  return w("div", P({}, K(t, "valueContainer", {
    "value-container": !0,
  ...
  return w("div", P({}, K(t, "indicatorsContainer", {
    indicators: !0
  }), i), r);
}, tr, ho = ["size"], Io = ["innerProps", "isRtl", "size"];
function Co() {
...
var Ao = process.env.NODE_ENV === "production" ? {
  ...
  var r = t.children, i = t.innerProps;
  return w("div", P({}, K(t, "dropdownIndicator", {
    indicator: !0,
    "dropdown-indicator": !0
  }), i), r || w(ai, null));
}, Eo = ui, Go = function(t) {
  var r = t.children, i = t.innerProps;
  return w("div", P({}, K(t, "clearIndicator", {
    indicator: !0,
    "clear-indicator": !0
  }), i), r || w(bn, null));
}, So = function(t, r) {
  ...
  var r = t.innerProps;
  return w("span", P({}, r, K(t, "indicatorSeparator", {
...
`]))), wo = function(t, r) {
  ...
  var r = t.innerProps, i = t.isRtl, n = t.size, a = n === void 0 ? 4 : n, o = Te(t, Io);
  return w("div", P({}, K(B(B({}, o), {}, {
    innerProps: r,
    isRtl: i,
    size: a
  }), "loadingIndicator", {
  ...
  r.data;
  var i = Te(r, Oo);
  return w("div", P({}, K(t, "groupHeading", {
    "group-heading": !0
  }), i));
...
var Ko = function(t) {
  ...
  return w(c, {
    ...
    data: n,
    innerProps: B({}, K(t, "multiValueLabel", {
      "multi-value__label": !0
    })),
    selectProps: u
  }, r), w(l, {
    data: n,
    innerProps: B(B({}, K(t, "multiValueRemove", {
  ...
  var r = t.children, i = t.innerProps;
  return w("div", P({}, K(t, "placeholder", {
    placeholder: !0
  }), i), r);
  ...
  return w("div", P({}, K(t, "singleValue", {
    "single-value": !0,
...
var bs = process.env.NODE_ENV === "production" ? {
  ...
  onFocus: function(t) {
    var r = t.context, i = t.focused, n = t.options, a = t.label, o = a === void 0 ? "" : a, s = t.selectValue, u = t.isDisabled, c = t.isSelected, f = t.isAppleDevice, l = function(p, v) {
      return p && p.length ? "".concat(p.indexOf(v) + 1, " of ").concat(p.length) : "";
    };
    if (r === "value" && s)
      return "value ".concat(o, " focused, ").concat(l(s, i), ".");
    if (r === "menu" && f) {
      var m = u ? " disabled" : "", b = "".concat(c ? " selected" : "").concat(m);
  ...
  var r = t.ariaSelection, i = t.focusedOption, n = t.focusedValue, a = t.focusableOptions, o = t.isFocused, s = t.selectValue, u = t.selectProps, c = t.id, f = t.isAppleDevice, l = u.ariaLiveMessages, m = u.getOptionLabel, b = u.inputValue, I = u.isMulti, p = u.isOptionDisabled, v = u.isSearchable, C = u.menuIsOpen, A = u.options, G = u.screenReaderStatus, h = u.tabSelectsValue, g = u.isLoading, x = u["aria-label"], E = u["aria-live"], S = Ye(function() {
    return B(B({}, ms), l || {});
  }, [l]), W = Ye(function() {
    var J = "";
    if (r && S.onChange) {
      var V = r.option, j = r.options, k = r.removedValue, ae = r.removedValues, le = r.value, xe = function(de) {
        return Array.isArray(de) ? null : de;
      }, _ = k || V || xe(le), ue = _ ? m(_) : "", Ie = j || ae || void 0, Ae = Ie ? Ie.map(m) : [], oe = B({
    ...
    return J;
  }, [r, S, p, s, m]), $ = Ye(function() {
    var J = "", V = i || n, j = !!(i && s && s.includes(i));
    if (V && S.onFocus) {
      var k = {
        focused: V,
        label: m(V),
    ...
    return J;
  }, [i, n, m, p, S, a, s, f]), q = Ye(function() {
    var J = "";
    if (C && A.length && !g && S.onFilter) {
      var V = G({
        count: a.length
      });
      J = S.onFilter({
    ...
    return J;
  }, [a, b, C, S, A, G, g]), U = r?.action === "initial-input-focus", Q = Ye(function() {
    var J = "";
    if (S.guidance) {
      var V = n ? "value" : C ? "menu" : "input";
      J = S.guidance({
        "aria-label": x,
        context: V,
        isDisabled: i && p(i, s),
    ...
    return J;
  }, [x, i, n, I, p, v, C, S, s, h, U]), ee = w(_t, null, w("span", {
    id: "aria-selection"
  }, W), w("span", {
    id: "aria-focused"
  }, $), w("span", {
...
function Rs(e) {
  var t = e.isEnabled, r = e.onBottomArrive, i = e.onBottomLeave, n = e.onTopArrive, a = e.onTopLeave, o = Re(!1), s = Re(!1), u = Re(0), c = Re(null), f = ce(function(v, C) {
    if (c.current !== null) {
      var A = c.current, G = A.scrollTop, h = A.scrollHeight, g = A.clientHeight, x = c.current, E = C > 0, S = h - g - G, W = !1;
      S > C && o.current && (i && i(v), o.current = !1), E && s.current && (a && a(v), s.current = !1), E && C > S ? (r && !o.current && r(v), x.scrollTop = h, W = !0, o.current = !0) : !E && -C > G && (n && !s.current && n(v), x.scrollTop = 0, W = !0, s.current = !0), W && Ss(v);
    }
  }, [r, i, n, a]), l = ce(function(v) {
    f(v, v.deltaY);
  }, [f]), m = ce(function(v) {
    ...
    if (v) {
      ...
      v.addEventListener("wheel", l, C), v.addEventListener("touchstart", m, C), v.addEventListener("touchmove", b, C);
    }
  }, [b, m, l]), p = ce(function(v) {
    v && (v.removeEventListener("wheel", l, !1), v.removeEventListener("touchstart", m, !1), v.removeEventListener("touchmove", b, !1));
  }, [b, m, l]);
  return Je(function() {
    if (t) {
      var v = c.current;
...
function Fs(e) {
  var t = e.isEnabled, r = e.accountForScrollbars, i = r === void 0 ? !0 : r, n = Re({}), a = Re(null), o = ce(function(u) {
    if (dr) {
      ...
      if (i && ar.forEach(function(I) {
        ...
        var l = parseInt(n.current.paddingRight, 10) || 0, m = document.body ? document.body.clientWidth : 0, b = window.innerWidth - m + l || 0;
...
function Ps(e) {
  var t = e.children, r = e.lockEnabled, i = e.captureEnabled, n = i === void 0 ? !0 : i, a = e.onBottomArrive, o = e.onBottomLeave, s = e.onTopArrive, u = e.onTopLeave, c = Rs({
    isEnabled: n,
    onBottomArrive: a,
    onBottomLeave: o,
    onTopArrive: s,
...
function fr(e, t, r, i) {
  var n = bi(e, t, r), a = vi(e, t, r), o = pi(e, t), s = St(e, t);
  return {
    type: "option",
    data: t,
    isDisabled: n,
...
var hi = function(t) {
  ...
  function r(i) {
    ...
    if (ga(this, r), n = t.call(this, i), n.state = {
      ...
      var f = n.props, l = f.onChange, m = f.name;
      c.name = m, n.ariaOnChange(u, c), l(u, c);
    }, n.setValue = function(u, c, f) {
      var l = n.props, m = l.closeMenuOnSelect, b = l.isMulti, I = l.inputValue;
      n.onInputChange("", {
        action: "set-value",
        prevInputValue: I
      }), m && (n.setState({
      ...
      var c = n.props, f = c.blurInputOnSelect, l = c.isMulti, m = c.name, b = n.state.selectValue, I = l && n.isOptionSelected(u, b), p = n.isOptionDisabled(u, b);
      if (I) {
        var v = n.getOptionValue(u);
        n.setValue(b.filter(function(C) {
          return n.getOptionValue(C) !== v;
        }), "deselect-option", u);
      } else if (!p)
      ...
      var c = n.props.isMulti, f = n.state.selectValue, l = n.getOptionValue(u), m = f.filter(function(I) {
      ...
      var u = n.props.isMulti, c = n.state.selectValue, f = c[c.length - 1], l = c.slice(0, c.length - 1), m = ft(u, l, l[0] || null);
      f && n.onChange(m, {
        action: "pop-value",
        removedValue: f
      });
    }, n.getFocusedOptionId = function(u) {
      return zt(n.state.focusableOptionsWithIds, u);
    }, n.getFocusableOptionsWithIds = function() {
      return gr(ht(n.props, n.state.selectValue), n.getElementId("option"));
    }, n.getValue = function() {
      ...
      var f = n.props.unstyled, l = js[u](c, f);
      ...
      var c = u.touches, f = c && c.item(0);
      if (f) {
        var l = Math.abs(f.clientX - n.initialTouchX), m = Math.abs(f.clientY - n.initialTouchY), b = 5;
        n.userIsDragging = l > b || m > b;
      }
      ...
      var c = n.props, f = c.isMulti, l = c.backspaceRemovesValue, m = c.escapeClearsValue, b = c.inputValue, I = c.isClearable, p = c.isDisabled, v = c.menuIsOpen, C = c.onKeyDown, A = c.tabSelectsValue, G = c.openMenuOnFocus, h = n.state, g = h.focusedOption, x = h.focusedValue, E = h.selectValue;
      if (!p && !(typeof C == "function" && (C(u), u.defaultPrevented))) {
        switch (n.blockOptionHover = !0, u.key) {
          ...
          case "Backspace":
            ...
            break;
          case "Tab":
            if (n.isComposing || u.shiftKey || !v || !A || !g || // don't capture the event if the menu opens on focus and the focused
          ...
          case "Escape":
            v ? (n.setState({
              ...
              action: "menu-close",
              prevInputValue: b
            }), n.onMenuClose()) : I && m && n.clearValue();
            break;
          case " ":
            if (b)
              return;
      ...
      n.state.focusableOptionsWithIds = a, n.state.focusedOption = o[s], n.state.focusedOptionId = zt(a, o[s]);
    }
    return n;
  }
  return pa(r, [{
    ...
    value: (
      ...
      // ==============================
      function() {
        return this.props.theme ? typeof this.props.theme == "function" ? this.props.theme(jt) : B(B({}, jt), this.props.theme) : jt;
      }
    )
  }, {
    key: "getCommonProps",
    value: function() {
      var n = this.clearValue, a = this.cx, o = this.getStyles, s = this.getClassNames, u = this.getValue, c = this.selectOption, f = this.setValue, l = this.props, m = l.isMulti, b = l.isRtl, I = l.options, p = this.hasValue();
      return {
        clearValue: n,
        cx: a,
        getStyles: o,
    ...
    value: (
      ...
      // ==============================
      function() {
        var n = this.props, a = n.isDisabled, o = n.isSearchable, s = n.inputId, u = n.inputValue, c = n.tabIndex, f = n.form, l = n.menuIsOpen, m = n.required, b = this.getComponents(), I = b.Input, p = this.state, v = p.inputIsHidden, C = p.ariaSelection, A = this.commonProps, G = s || this.getElementId("input"), h = B(B(B({
        ...
        return o ? /* @__PURE__ */ O.createElement(I, P({}, A, {
          autoCapitalize: "none",
          autoComplete: "off",
          autoCorrect: "off",
          id: G,
          ...
          type: "text",
          value: u
        }, h)) : /* @__PURE__ */ O.createElement(Gs, P({
          id: G,
          innerRef: this.getInputRef,
          onBlur: this.onInputBlur,
          onChange: Et,
    ...
    value: function() {
      var n = this, a = this.getComponents(), o = a.MultiValue, s = a.MultiValueContainer, u = a.MultiValueLabel, c = a.MultiValueRemove, f = a.SingleValue, l = a.Placeholder, m = this.commonProps, b = this.props, I = b.controlShouldRenderValue, p = b.isDisabled, v = b.isMulti, C = b.inputValue, A = b.placeholder, G = this.state, h = G.selectValue, g = G.focusedValue, x = G.isFocused;
      if (!this.hasValue() || !I)
        return C ? null : /* @__PURE__ */ O.createElement(l, P({}, m, {
          key: "placeholder",
          isDisabled: p,
          isFocused: x,
          innerProps: {
      ...
      if (v)
        return h.map(function(S, W) {
          var $ = S === g, q = "".concat(n.getOptionLabel(S), "-").concat(n.getOptionValue(S));
          return /* @__PURE__ */ O.createElement(o, P({}, m, {
            components: {
              Container: s,
              Label: u,
              Remove: c
      ...
      if (C)
        return null;
      var E = h[0];
      return /* @__PURE__ */ O.createElement(f, P({}, m, {
        data: E,
        isDisabled: p
    ...
    value: function() {
      ...
      return /* @__PURE__ */ O.createElement(a, P({}, o, {
        innerProps: l,
        isFocused: f
      }));
    }
    ...
    value: function() {
      ...
      return /* @__PURE__ */ O.createElement(o, P({}, s, {
        isDisabled: u,
        isFocused: c
      }));
    }
    ...
    key: "renderMenu",
    value: function() {
      var n = this, a = this.getComponents(), o = a.Group, s = a.GroupHeading, u = a.Menu, c = a.MenuList, f = a.MenuPortal, l = a.LoadingMessage, m = a.NoOptionsMessage, b = a.Option, I = this.commonProps, p = this.state.focusedOption, v = this.props, C = v.captureMenuScroll, A = v.inputValue, G = v.isLoading, h = v.loadingMessage, g = v.minMenuHeight, x = v.maxMenuHeight, E = v.menuIsOpen, S = v.menuPlacement, W = v.menuPosition, $ = v.menuPortalTarget, q = v.menuShouldBlockScroll, U = v.menuShouldScrollIntoView, Q = v.noOptionsMessage, ee = v.onMenuScrollToTop, J = v.onMenuScrollToBottom;
      if (!E) return null;
      var V = function(ue, Ie) {
        var Ae = ue.type, oe = ue.data, ve = ue.isDisabled, de = ue.isSelected, Ee = ue.label, Oe = ue.value, De = p === oe, F = ve ? void 0 : function() {
          return n.onOptionHover(oe);
        }, Xe = ve ? void 0 : function() {
          return n.selectOption(oe);
        }, we = "".concat(n.getElementId("option"), "-").concat(Ie), Ve = {
          id: we,
          onClick: Xe,
          onMouseMove: F,
          onMouseOver: F,
          tabIndex: -1,
          role: "option",
          "aria-selected": n.state.isAppleDevice ? void 0 : de
          // is not supported on Apple devices
        };
        return /* @__PURE__ */ O.createElement(b, P({}, I, {
          innerProps: Ve,
          data: oe,
          isDisabled: ve,
          isSelected: de,
      ...
      if (this.hasOptions())
        j = this.getCategorizedOptions().map(function(_) {
          if (_.type === "group") {
            var ue = _.data, Ie = _.options, Ae = _.index, oe = "".concat(n.getElementId("group"), "-").concat(Ae), ve = "".concat(oe, "-heading");
            return /* @__PURE__ */ O.createElement(o, P({}, I, {
              key: oe,
              data: ue,
              options: Ie,
              Heading: s,
              ...
              label: n.formatGroupLabel(_.data)
            }), _.options.map(function(de) {
              return V(de, "".concat(Ae, "-").concat(de.index));
            }));
          } else if (_.type === "option")
            return V(_, "".concat(_.index));
        });
      else if (G) {
        var k = h({
          inputValue: A
        ...
        j = /* @__PURE__ */ O.createElement(l, I, k);
      } else {
        var ae = Q({
          inputValue: A
        });
        if (ae === null) return null;
        j = /* @__PURE__ */ O.createElement(m, I, ae);
      }
      var le = {
        minMenuHeight: g,
        maxMenuHeight: x,
      ...
      }, xe = /* @__PURE__ */ O.createElement(eo, P({}, I, le), function(_) {
        var ue = _.ref, Ie = _.placerProps, Ae = Ie.placement, oe = Ie.maxHeight;
        return /* @__PURE__ */ O.createElement(u, P({}, I, le, {
          innerRef: ue,
          innerProps: {
          ...
          return /* @__PURE__ */ O.createElement(c, P({}, I, {
            innerRef: function(Ee) {
              n.getMenuListRef(Ee), ve(Ee);
            },
            innerProps: {
              role: "listbox",
      ...
      return $ || W === "fixed" ? /* @__PURE__ */ O.createElement(f, P({}, I, {
        appendTo: $,
    ...
    value: function() {
      ...
      if (f && !this.hasValue() && !s)
        return /* @__PURE__ */ O.createElement(Ws, {
          name: c,
      ...
      if (!(!c || s))
        if (u)
          if (o) {
            var m = l.map(function(p) {
              return n.getOptionValue(p);
            }).join(o);
            return /* @__PURE__ */ O.createElement("input", {
              name: c,
              type: "hidden",
              value: m
            });
          } else {
            var b = l.length > 0 ? l.map(function(p, v) {
              return /* @__PURE__ */ O.createElement("input", {
                key: "i-".concat(v),
                name: c,
                type: "hidden",
            ...
            return /* @__PURE__ */ O.createElement("div", null, b);
          }
        else {
    ...
    value: function() {
      ...
      return /* @__PURE__ */ O.createElement(Is, P({}, n, {
    ...
    key: "render",
    value: function() {
      var n = this.getComponents(), a = n.Control, o = n.IndicatorsContainer, s = n.SelectContainer, u = n.ValueContainer, c = this.props, f = c.className, l = c.id, m = c.isDisabled, b = c.menuIsOpen, I = this.state.isFocused, p = this.commonProps = this.getCommonProps();
      return /* @__PURE__ */ O.createElement(s, P({}, p, {
        className: f,
        innerProps: {
          id: l,
        ...
        isDisabled: m,
        isFocused: I
      }), this.renderLiveRegion(), /* @__PURE__ */ O.createElement(a, P({}, p, {
        ...
        isFocused: I,
        menuIsOpen: b
      }), /* @__PURE__ */ O.createElement(u, P({}, p, {
        isDisabled: m
      }), this.renderPlaceholderOrValue(), this.renderInput()), /* @__PURE__ */ O.createElement(o, P({}, p, {
        isDisabled: m
    ...
    value: function(n, a) {
      var o = a.prevProps, s = a.clearFocusValueOnUpdate, u = a.inputIsHiddenAfterUpdate, c = a.ariaSelection, f = a.isFocused, l = a.prevWasFocused, m = a.instancePrefix, b = n.options, I = n.value, p = n.menuIsOpen, v = n.inputValue, C = n.isMulti, A = Kn(I), G = {};
      if (o && (I !== o.value || b !== o.options || p !== o.menuIsOpen || v !== o.inputValue)) {
        var h = p ? Ks(n, A) : [], g = p ? gr(ht(n, A), "".concat(m, "-option")) : [], x = s ? qs(a, A) : null, E = ec(a, h), S = zt(g, E);
        G = {
          selectValue: A,
          focusedOption: E,
          focusedOptionId: S,
      ...
      return f && !q && ($ = {
        value: ft(C, A, A[0] || null),
        options: A,
        action: "initial-input-focus"
      }, q = !l), c?.action === "initial-input-focus" && ($ = null), B(B(B({}, G), W), {}, {
        prevProps: n,
        ariaSelection: $,
        prevWasFocused: q
      });
...
var nc = /* @__PURE__ */ Vr(function(e, t) {
  var r = fa(e);
  return /* @__PURE__ */ O.createElement(Ii, P({
    ref: t
  }, r));
}), rc = nc;
const ic = ({ data: e, isSelected: t, isFocused: r, innerProps: i }) => {
  const n = [
    "snippet-select-option",
    t ? "snippet-select-option--selected" : "",
    r ? "snippet-select-option--focused" : ""
  ].filter(Boolean).join(" ");
  return /* @__PURE__ */ M.jsxs("div", { ...i, className: n, children: [
    /* @__PURE__ */ M.jsx("div", { className: "snippet-select-option-title", children: e.label }),
    e.categories && e.categories.length > 0 && /* @__PURE__ */ M.jsx("div", { className: "snippet-select-option-categories", children: e.categories.map((a, o) => /* @__PURE__ */ M.jsx(
      "span",
      {
  ...
  const i = {
    control: (n, a) => ({
      ...
      borderRadius: "4px",
      boxShadow: a.isFocused ? "0 0 0 1px #007cba" : "none",
      "&:hover": {
        borderColor: "#007cba"
      }
    }),
    option: (n, a) => ({
      ...n,
      backgroundColor: a.isSelected ? "#007cba" : a.isFocused ? "#f0f0f0" : "white",
      color: a.isSelected ? "white" : "black",
      "&:hover": {
        backgroundColor: a.isSelected ? "#007cba" : "#f0f0f0"
      }
    }),
    menu: (n) => ({
      ...n,
  ...
  return /* @__PURE__ */ M.jsxs("div", { className: "snippet-sidebar", children: [
    /* @__PURE__ */ M.jsx("div", { className: "snippet-sidebar-header", children: /* @__PURE__ */ M.jsx("h3", { children: "Snippets" }) }),
    /* @__PURE__ */ M.jsx("div", { className: "snippet-sidebar-list", children: e.map((n) => /* @__PURE__ */ M.jsxs(
      "div",
      {
        className: `snippet-sidebar-item ${t === n.value ? "active" : ""}`,
        onClick: () => i(n.value),
        children: [
          /* @__PURE__ */ M.jsx("div", { className: "snippet-sidebar-title", children: n.label }),
          n.categories && n.categories.length > 0 && /* @__PURE__ */ M.jsx("div", { className: "snippet-sidebar-categories", children: n.categories.map((a, o) => /* @__PURE__ */ M.jsx("span", { className: "snippet-sidebar-category", children: a }, o)) })
        ]
      },
      n.value
    )) })
  ] });
}, oc = ({ fields: e, form: t, onFieldChange: r }) => e.length === 0 ? null : /* @__PURE__ */ M.jsx("div", { className: "snippet-form", children: e.map((i) => /* @__PURE__ */ M.jsxs("div", { className: "snippet-field", children: [
  /* @__PURE__ */ M.jsx(
    "label",
    {
      htmlFor: `snippet-field-${i.name}`,
  ...
  /* @__PURE__ */ M.jsx(
    "input",
    {
      id: `snippet-field-${i.name}`,
      type: "text",
      value: t[i.name] || "",
      onChange: (n) => r(i.name, n.target.value),
      className: "snippet-input regular-text",
      placeholder: i.placeholder || `Enter ${i.label || i.name}`
    }
  )
] }, i.name)) }), sc = ({
  processedOutput: e,
  ...
  onCopy: r,
  copied: i
}) => !e && !t ? null : /* @__PURE__ */ M.jsx("div", { className: "snippet-output-container", children: /* @__PURE__ */ M.jsxs("div", { className: "snippet-output-content", children: [
  t && !e && /* @__PURE__ */ M.jsx("div", { className: "snippet-loading", children: "Generating snippet..." }),
  ...
  const {
    autoCopy: r = !1,
    autoCopyDebounceDelay: i = 500,
    layout: n = "dropdown"
    // New layout prop with dropdown as default
  } = t, [a, o] = ge({}), [s, u] = ge(""), [c, f] = ge([]), [l, m] = ge({}), [b, I] = ge(""), [p, v] = ge(""), [C, A] = ge(""), [G, h] = ge(!1), [g, x] = ge(!1), E = Re(null), S = ce((V) => {
    E.current && clearTimeout(E.current), E.current = setTimeout(() => {
      V && r && navigator.clipboard.writeText(V).then(() => {
  ...
  Je(() => () => {
    ...
    e.getSnippets().then(o).catch((V) => A(V.message || "Error fetching snippets"));
  }, [e]);
  const W = ce((V, j) => {
    let k = V;
    return Object.keys(j).forEach((ae) => {
      const le = j[ae] || "", xe = `{{${ae}}}`;
      k = k.replace(new RegExp(xe.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), "g"), le);
    }), k;
  }, []);
  Je(() => {
    if (b) {
    ...
    s && a[s] && (f(a[s].fields || []), m({}), I(""), v(""), A(""), h(!1), x(!1), !a[s].fields || a[s].fields.length === 0 ? (x(!0), e.renderSnippet(s, {}).then((V) => {
      I(V.output), x(!1);
    }).catch((V) => {
      A(V.message || "Error rendering snippet"), x(!1);
    })) : (x(!0), e.renderSnippet(s, {}).then((V) => {
      I(V.output), x(!1);
    }).catch((V) => {
      A(V.message || "Error rendering snippet"), x(!1);
    })));
  ...
  const $ = (V, j) => {
  ...
  }, Q = Object.keys(a).map((V) => {
    const j = a[V], k = j.meta && j.meta.title ? j.meta.title : V, ae = j.categories && Array.isArray(j.categories) ? j.categories : [];
    return {
      value: V,
      label: k,
      categories: ae
    };
  }), ee = `snippets-app--${n}`, J = () => /* @__PURE__ */ M.jsxs("div", { className: "snippets-app-content", children: [
    /* @__PURE__ */ M.jsx(
      oc,
      {
        fields: c,
    ...
    C && /* @__PURE__ */ M.jsx("div", { className: "snippet-error-message", children: C })
  ] });
  return /* @__PURE__ */ M.jsx("div", { className: `snippets-app ${ee}`, children: n === "sidebar" ? /* @__PURE__ */ M.jsxs(M.Fragment, { children: [
    /* @__PURE__ */ M.jsx(
      uc,
      {
        snippetOptions: Q,
...
function cc() {
  return br || (br = 1, function(e) {
    (function() {
      ...
      function n(s, u) {
        var c = 1, f = s.length, l, m = "", b, I, p, v, C, A, G, h;
        for (b = 0; b < f; b++)
          if (typeof s[b] == "string")
            ...
            t.json.test(p.type) ? m += l : (t.number.test(p.type) && (!G || p.sign) ? (h = G ? "+" : "-", l = l.toString().replace(t.sign, "")) : h = "", C = p.pad_char ? p.pad_char === "0" ? "0" : p.pad_char.charAt(1) : " ", A = p.width - (h + l).length, v = p.width && A > 0 ? C.repeat(A) : "", m += p.align ? h + l + v : C === "0" ? h + v + l : v + h + l);
          }
        return m;
      }
          ...
          if ((c = t.text.exec(u)) !== null)
            ...
            if (c[2]) {
              ...
              if ((I = t.key.exec(b)) !== null)
                for (m.push(I[1]); (b = b.substring(I[0].length)) !== ""; )
...
const mr = {
...
}, vc = /^i18n\.(n?gettext|has_translation)(_|$)/, mc = (e, t, r) => {
  const i = new mn({}), n = /* @__PURE__ */ new Set(), a = () => {
  ...
  }, m = (h = "default", g, x, E, S) => (i.data[h] || u(void 0, h), i.dcnpgettext(h, g, x, E, S)), b = (h = "default") => h, I = (h, g) => {
    let x = m(g, void 0, h);
    ...
    let S = m(E, void 0, h, g, x);
    return r ? (S = /** @type {string} */
    /** @type {*} */
    r.applyFilters("i18n.ngettext", S, h, g, x, E), /** @type {string} */
    /** @type {*} */
    r.applyFilters("i18n.ngettext_" + b(E), S, h, g, x, E)) : S;
  }, C = (h, g, x, E, S) => {
    let W = m(S, E, h, g, x);
    return r ? (W = /** @type {string} */
    /** @type {*} */
    r.applyFilters("i18n.ngettext_with_context", W, h, g, x, E, S), /** @type {string} */
    /** @type {*} */
    r.applyFilters("i18n.ngettext_with_context_" + b(S), W, h, g, x, E, S)) : W;
  }, A = () => p("ltr", "text direction") === "rtl", G = (h, g, x) => {
    const E = g ? g + "" + h : h;
    let S = !!i.data?.[x ?? "default"]?.[E];
    return r && (S = /** @type { boolean } */
    /** @type {*} */
    r.applyFilters("i18n.has_translation", S, h, g, x), S = /** @type { boolean } */
    /** @type {*} */
    r.applyFilters("i18n.has_translation_" + b(x), S, h, g, x)), S;
  };
  if (r) {
    const h = (g) => {
      vc.test(g) && a();
  ...
  return function(a, ...o) {
    ...
    async function f() {
      try {
        ...
        for (; c.currentIndex < u.length; )
          m = await u[c.currentIndex].callback.apply(null, o), r && (o[0] = m), c.currentIndex++;
        return r ? m : void 0;
      } finally {
    ...
    function l() {
      try {
        ...
        let m = r ? o[0] : void 0;
        for (; c.currentIndex < u.length; )
          m = u[c.currentIndex].callback.apply(null, o), r && (o[0] = m), c.currentIndex++;
        return r ? m : void 0;
      } finally {
        s.__current.delete(c);
      }
...
const xi = Ic(), {
  ...
  actions: dl,
  filters: fl
} = xi, ie = mc(void 0, void 0, xi);
ie.getLocaleData.bind(ie);
ie.setLocaleData.bind(ie);
ie.resetLocaleData.bind(ie);
ie.subscribe.bind(ie);
const Pt = ie.__.bind(ie);
ie._x.bind(ie);
ie._n.bind(ie);
ie._nx.bind(ie);
ie.isRTL.bind(ie);
ie.hasTranslation.bind(ie);
function Cc(e) {
  const t = (r, i) => {
    const {
      headers: n = {}
...
function Tt(e) {
  return (yc(e) || "").replace(/\+/g, "%20").split("&").reduce((t, r) => {
    const [i, n = ""] = r.split("=").filter(Boolean).map(Ec);
    if (i) {
...
function Sc(e) {
  ...
  return (r, i) => {
    ...
    if (o === "GET" && t[s]) {
      const u = t[s];
      return delete t[s], Sr(u, !!n);
    } else if (o === "OPTIONS" && t[o] && t[o][s]) {
      const u = t[o][s];
      return delete t[o][s], Sr(u, !!n);
    }
    return i(r);
  };
}
...
const Rc = ({
  ...
  url: t && Ne(t, i),
  path: e && Ne(e, i)
}), Rr = (e) => e.json ? e.json() : Promise.reject(e), Fc = (e) => {
  if (!e)
    return {};
  ...
  return a;
}, Vc = /* @__PURE__ */ new Set(["PATCH", "PUT", "DELETE"]), Bc = "GET", Pc = (e, t) => {
  const {
    method: r = Bc
  } = e;
  return Vc.has(r.toUpperCase()) && (e = {
    ...e,
    headers: {
      ...e.headers,
...
}, Tc = (e, t) => (typeof e.url == "string" && !xr(e.url, "_locale") && (e.url = Ne(e.url, {
  _locale: "user"
})), typeof e.path == "string" && !xr(e.path, "_locale") && (e.path = Ne(e.path, {
  _locale: "user"
})), t(e)), Oc = (e, t = !0) => t ? e.status === 204 ? null : e.json ? e.json() : Promise.reject(e) : e, Xc = (e) => {
  const t = {
    code: "invalid_json",
...
}, Ri = (e, t = !0) => Promise.resolve(Oc(e, t)).catch((r) => In(r, t));
function In(e, t = !0) {
  if (!t)
    throw e;
  return Xc(e).then((r) => {
...
const wi = (e) => {
  ...
  ).then((c) => Promise.resolve(c).then(wi).catch((f) => In(f, n)).then((f) => Ri(f, n)), (c) => {
...
function be(e) {
  return Fi.reduceRight((r, i) => (n) => i(n, r), Vi)(e).catch((r) => r.code !== "rest_cookie_invalid_nonce" ? Promise.reject(r) : window.fetch(be.nonceEndpoint).then(wi).then((i) => i.text()).then((i) => (be.nonceMiddleware.nonce = i, be(e))));
}
be.use = Hc;
be.setFetchHandler = Yc;
be.createNonceMiddleware = Cc;
be.createPreloadingMiddleware = Sc;
be.createRootURLMiddleware = Ac;
be.fetchAllMiddleware = Si;
be.mediaUploadMiddleware = Mc;
be.createThemePreviewMiddleware = Nc;
const gl = (e, t) => {
...
export {
  zc as SnippetsApp,
  pl as createChromeApi,
  gl as createWordpressApi
};
